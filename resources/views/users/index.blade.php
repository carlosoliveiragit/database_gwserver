...
<div class="card card-default">
    ...
    <form action="users" method="post">
        ...
        <div class="row p-2">
            <div class="col-sm">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" name="name" class="form-control" placeholder="Nome do novo Usuário" required>
                </div>
            </div>
            <div class="col-sm">
                <label>Senha</label>
        ...
        <div class="row p-2">
            <div class="col-sm">
                <x-adminlte-select2 name="profiles_profile" label="Perfil de Usuário"
