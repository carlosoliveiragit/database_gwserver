...
@section('title', 'Dashboard GW | UP POP OPR')
@section('plugins.Select2', true)

@section('content_header')
<div class="col-sm">
    <h4><i class="fa-solid fa-file-arrow-up"></i> &nbsp;&nbsp;UPLOAD - PROCEDIMENTO OPERACIONAL PADRÃO - OPERAÇÃO</h4>
</div>
    <div class="row p-2">
        <div class="col-sm">
            @if (session('success'))
...
@section('content')
    <div class="card card-default">
        ...
        <form id="fileUploadForm" action="upload_pop_opr" method="POST" enctype="multipart/form-data">
            @csrf
