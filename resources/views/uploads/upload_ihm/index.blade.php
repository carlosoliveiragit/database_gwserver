        ...
        <div class="row p-2">
            <div class="col-sm" hidden>
                <x-adminlte-select2 name="type" label="Tipo" data-placeholder="Select Type..." required>
                    ...
                    <option value="IHM" selected></option>
                </x-adminlte-select2>
            </div>
            <div class="col-sm">
                <x-adminlte-select2 name="type_Ident" label="3º - Identificação" data-placeholder="Select Type..." required>
                    <x-slot name="prependSlot">
                        <div class="input-group-text text-primary">
                            <i class="fas fa-solid fa-file"></i>
                        </div>
            ...
            <div class="col-sm">
                ...
                <x-adminlte-input-file type="file" accept=".cxob" id="upload" name="upload" label="4º - Upload file"
