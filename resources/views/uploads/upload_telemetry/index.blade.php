...
<div class="card card-default">
    ...
    <form id="fileUploadForm" action="upload_telemetry" method="POST" enctype="multipart/form-data">
        ...
        <div class="row p-2">
            ...
            <div class="col-sm">
                <x-adminlte-select2 name="types_type" label="Tipo" data-placeholder="Selecione o Tipo..." required>
                    <x-slot name="prependSlot">
                        <div class="input-group-text text-primary">
        ...
        <div class="row p-2" id="textUploadContainer" style="display: none;">
            <div class="col-sm">
                ...
                <textarea class="form-control" name="json_text" id="jsonText" rows="6"
                    placeholder="Cole seu JSON aqui..."></textarea required>>
            </div>
        </div>
        <div class="row p-2">
            <div class="col-sm">
