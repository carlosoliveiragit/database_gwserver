...
@section('content_header')
    <div class="row p-2">
        <div class="col-sm">
            <h4><i class="fa-solid fa-vector-square"></i> &nbsp;&nbsp;Atualização de Dados</h4>
        </div>
        <div class="col-sm">
            @if (session('success'))
...
@section('content')
    ...
    <div class="card card-default">
        <div class="card-header">
            <h2 class="card-title">
                &nbsp;&nbsp;Editando Tipo: {{$Sectors->sector}} </h2>
        </div>
        <p></p>
        <form action="{{ $Sectors->id }}" method="POST">
            @csrf
            @method('PUT') 
            <div class="class row p-2">
                <div class="col-sm">
                    <div class="form-group">
                        <input type="text" class="form-control" id="type" name="sector"
                            placeholder="Nome do Novo Tipo" value="{{$Sectors->sector}}" required>
                    </div>
                </div>
                <div class="col-sm">
