...
class UploadPopOprController extends Controller
{
    protected $user;
    ...
    public function index()
    {
        ...
        return view('uploads.upload_pop_opr.index', [
            'Clients' => $Clients,
            'Systems' => $Systems,
            'Users' => $Users
        ]);
    ...
    return redirect('upload_pop_opr')->with('success', 'Upload realizado com sucesso');
}
}
