...
class ClpAbbController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('uploads.clp_abb.index', ['Clients' => $Clients], ['Systems' => $Systems], ['Users' => $Users]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->hasFile('upload') && $request->file('upload')->isValid()) {
            ...
            if (($extension) != ('projectarchive')) {
                ...
                return redirect('clp_abb')->with('error', 'Extensão: ' .$extension.' '. 'não compativel com Modelo'.' ' .$request->model);
